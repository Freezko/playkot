 ...
 * Generated for Laravel 4.2.17 on 2015-04-25.
 *
...
namespace {
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
         ...
         *
         * @param string $name
         * @return \Kodeks\PhpResque\ResqueQueue 
         * @static 
         */
        public static function connection($name = null){
         ...
         * @static 
         */
        public static function push($job, $data = array(), $queue = null, $track = true){
            return \Kodeks\PhpResque\ResqueQueue::push($job, $data, $queue, $track);
        }
         ...
         * @static 
         */
        public static function reserve($queue = null){
            return \Kodeks\PhpResque\ResqueQueue::reserve($queue);
        }
         ...
         * @static 
         */
        public static function jobStatus($token){
            return \Kodeks\PhpResque\ResqueQueue::jobStatus($token);
        }
         ...
         * @static 
         */
        public static function isWaiting($token){
            return \Kodeks\PhpResque\ResqueQueue::isWaiting($token);
        }
         ...
         * @static 
         */
        public static function isRunning($token){
            return \Kodeks\PhpResque\ResqueQueue::isRunning($token);
        }
         ...
         * @static 
         */
        public static function isFailed($token){
            return \Kodeks\PhpResque\ResqueQueue::isFailed($token);
        }
         ...
         * @static 
         */
        public static function isComplete($token){
            return \Kodeks\PhpResque\ResqueQueue::isComplete($token);
        }
         ...
         * @static 
         */
        public static function later($delay, $job, $data = array(), $queue = null){
            return \Kodeks\PhpResque\ResqueQueue::later($delay, $job, $data, $queue);
        }
        ...
        public static function listen($event, $function){
            return \Kodeks\PhpResque\ResqueQueue::listen($event, $function);
        }
        ...
        public static function pop($queue = null){
            return \Kodeks\PhpResque\ResqueQueue::pop($queue);
        }
        ...
        public static function size($queue = null){
            return \Kodeks\PhpResque\ResqueQueue::size($queue);
        }
        ...
        public static function pushRaw($payload, $queue = null, $options = array()){
            return \Kodeks\PhpResque\ResqueQueue::pushRaw($payload, $queue, $options);
        }
        ...
        public static function marshal(){
            ...
            return \Kodeks\PhpResque\ResqueQueue::marshal();
        }
        ...
        public static function bulk($jobs, $data = '', $queue = null){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Kodeks\PhpResque\ResqueQueue::bulk($jobs, $data, $queue);
        }
        ...
        public static function getTime(){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Kodeks\PhpResque\ResqueQueue::getTime();
        }
        ...
        public static function setContainer($container){
            //Method inherited from \Illuminate\Queue\Queue            
            \Kodeks\PhpResque\ResqueQueue::setContainer($container);
        }
        ...
        public static function setEncrypter($crypt){
            //Method inherited from \Illuminate\Queue\Queue            
            \Kodeks\PhpResque\ResqueQueue::setEncrypter($crypt);
        }
